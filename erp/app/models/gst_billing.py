...
class GstInvoice(db.Model):
    ...
    PayBankAccounts: Mapped[str | None] = mapped_column(Unicode(2000), nullable=True)
    ...
    InvoicePaymentReceived: Mapped[bool | None] = mapped_column(Boolean, nullable=True)
    InvoicePaymentRemoveReason: Mapped[str | None] = mapped_column(Unicode(500), nullable=True)
