...
class WebsiteDscApplication(db.Model):
    ...
    AadhaarBackDocPath: Mapped[str | None] = mapped_column(Unicode(400), nullable=True)
    AadhaarBackDocName: Mapped[str | None] = mapped_column(Unicode(180), nullable=True)
    ...
    OcrVerified: Mapped[bool] = mapped_column(Boolean, nullable=False, default=False)
    OcrName: Mapped[str | None] = mapped_column(Unicode(160), nullable=True)
    OcrPan: Mapped[str | None] = mapped_column(Unicode(10), nullable=True)
    OcrAadhaarLast4: Mapped[str | None] = mapped_column(Unicode(4), nullable=True)
    OcrAddress: Mapped[str | None] = mapped_column(Unicode(400), nullable=True)
