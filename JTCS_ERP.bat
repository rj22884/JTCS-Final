...
REM Canonical GitHub repository (new)
...
:ensure_git_remote
REM Point origin at the new GitHub repo (idempotent).
...
:clear_git_lock
REM Remove stale .git/index.lock (common when a previous git crashed).
...
:git_commit_push
REM Shared: stage, commit, push current branch to new GitHub origin.
call :ensure_git_remote
call :init_branch
...
REM =============================================================================
REM 2. Push and deploy (normal - git pull/reset on VPS via deploy.sh)
REM =============================================================================
:push_and_deploy
call :require_git
call :require_ssh
